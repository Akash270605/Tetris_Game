...
public class ResourceManager {
    ...
    //Reads all .png files inside textures folder
    public static void readImageFiles(){
        File texturesFolder = new File("src/res/textures");
    ...
    public static int[] readHighscoresFile(){
        ...
        try{
            reader= new BufferedReader(new FileReader("C:/Users/Leveno/Codes/Java Codes/Tetris_Game/src/res/highscores.txt"));
        }catch(FileNotFoundException e1){
            System.out.println("[Framework][Resource]: File highscores.txt not found");
            System.exit(-1);
            return null;
        }
        ...
        try{
            ...
            System.out.println("[Framework][Resources]: IOException occured when reading highscores");
        }
    ...
    public static void writeHighscores(int[] scores){
        ...
        try{
            writer= new PrintWriter(new File("C:/Users/Leveno/Codes/Java Codes/Tetris_Game/src/res/highscores.txt"));
